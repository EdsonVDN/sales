...
const eventTitleStyle = {
  fontSize: "16px", // Defina um tamanho de fonte menor
...
const useStyles = makeStyles((theme) => ({
  mainPaper: {
    ...
    backgroundColor:theme.palette.mainbox, 
    borderRadius:"16px",
...
const Schedules = () => {
  ...
  return (
    <MainContainer>
      ...
      <MainHeader>
        <Title>
  <span className="gradient-title">{i18n.t("schedules.title")} ({schedules.length})</span>
</Title>
